#include"appliance.h"
int appliance::operator=(Commodity &com)
{
...
void appliance::checkquantity()
{
	int now_year,now_month,now_day,time;
	cout<<"请输入现在日期：";cin>>now_year;cin>>now_month;cin>>now_day;
	time=(now_year-com_begin_time.year-1)*365+(12-now_month+com_begin_time.month)*30+(30-now_day+com_begin_time.day);
	if(time>com_deadline_time)
	{
		cout<<"商品过期！"<<endl; 
	 }
	else
